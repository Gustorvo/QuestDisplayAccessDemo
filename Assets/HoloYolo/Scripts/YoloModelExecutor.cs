...
namespace Assets.Scripts
{
    ...
    public class YoloModelExecutor : MonoBehaviour
    {
        ...
        private static VideoSourceAccess VideoSourceAccess => VideoSourceAccess.Instance;
        ...
        private void Start()
        {
            ...
            this.ShaderForScaling.SetFloat("_Aspect",
                (float)VideoSourceAccess.ActualCameraSize.x / VideoSourceAccess.ActualCameraSize.y * Parameters.ModelImageResolution.y / Parameters.ModelImageResolution.x);
        ...
        private void Update()
        {
            switch (this.modelState)
            {
                ...
                case ModelState.PreProcessing:
                    ...
                    this.cameraTransform = new CameraTransform(camera);

                    Graphics.Blit(VideoSourceAccess.Texture, this.intermediateRenderTexture, this.ShaderForScaling);
